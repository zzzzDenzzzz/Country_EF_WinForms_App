...
namespace Country_EF_WinForms_App.Forms.CountryForms
{
    public partial class UpdateCountryForm : Form
    {
        ...
        public UpdateCountryForm(string name, decimal area, decimal population, PartsOfTheWorld partOfTheWorld)
        {
            InitializeComponent();
            txtCountryName.Text = name;
            numericArea.Value = area;
            numericPopulationCountry.Value = population;
            comboBoxPartOfTheWorld.SelectedValue = partOfTheWorld;
            GetDescriptionPartOfTheWorld(partOfTheWorld);
        }

        void GetDescriptionPartOfTheWorld(PartsOfTheWorld part = PartsOfTheWorld.ASIA)
        {
            ...
            comboBoxPartOfTheWorld.SelectedItem = pairs.First(x => x.Value == (int)part);
        }
